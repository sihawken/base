...
RUN rpm-ostree override remove toolbox firefox firefox-langpacks && \
    ...
    rpm-ostree override replace ${KERNEL_REPO}/kernel-${KERNEL_VERSION}.rpm ${KERNEL_REPO}/kernel-core-${KERNEL_VERSION}.rpm ${KERNEL_REPO}/kernel-modules-${KERNEL_VERSION}.rpm ${KERNEL_REPO}/kernel-modules-extra-${KERNEL_VERSION}.rpm --install ${KERNEL_REPO}/kernel-devel-${KERNEL_VERSION}.rpm --install ${KERNEL_REPO}/kernel-devel-matched-${KERNEL_VERSION}.rpm && \
