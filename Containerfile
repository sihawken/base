...
RUN rpm-ostree override remove toolbox firefox firefox-langpacks && \
    ...
    rpm-ostree install ${KERNEL_REPO}/kernel-xanmod-edge-${KERNEL_VERSION}.rpm ${KERNEL_REPO}/kernel-xanmod-edge-core-${KERNEL_VERSION}.rpm ${KERNEL_REPO}/kernel-xanmod-edge-modules-${KERNEL_VERSION}.rpm ${KERNEL_REPO}/kernel-xanmod-edge-devel-${KERNEL_VERSION}.rpm ${KERNEL_REPO}/kernel-xanmod-edge-devel-matched-${KERNEL_VERSION}.rpm && \
